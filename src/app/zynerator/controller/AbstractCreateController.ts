...
import {EchelleCriteria} from "../../controller/criteria/EchelleCriteria.model";
    ...
    public saveWithShowOption(showList: boolean) {
        ...
        this.myService.save().subscribe(item => {
          ...
          //  alert(error.error.message);
            this.myMessageService.add({severity: 'error', summary: 'Erreurs', detail: error.error.message});
