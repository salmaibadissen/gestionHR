...
export class AbsenceEditAdminComponent extends AbstractEditController<AbsenceDto, AbsenceCriteria, AbsenceService>   implements OnInit {
    ...
    constructor(private datePipe: DatePipe, private absenceService: AbsenceService
        ...
        ,private employeService:EmployeService, private confirmationService: ConfirmationService, private router: Router, private departementService: DepartementService, private sexeService: SexeService, private localService:LocalService
